    ...
    sourceSets {
        commonMain {
            dependencies {
                ...
                implementation(project(":shared:feature:general:home:presentation"))
...
android { namespace = "com.sideki.test.shared.feature.general.home.compose" }
...
ksp {
    arg("compose-destinations.codeGenPackageName", "com.sideki.test.shared.feature.general.home.compose")
